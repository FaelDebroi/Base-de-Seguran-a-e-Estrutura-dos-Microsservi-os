    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(new AntPathRequestMatcher("/auth/requestcode", HttpMethod.POST.name())).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/auth/verify-code", HttpMethod.POST.name())).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/users/update-profile", HttpMethod.POST.name())).authenticated()
                .requestMatchers(new AntPathRequestMatcher("/users/me", HttpMethod.GET.name())).authenticated()
